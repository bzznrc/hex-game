...
def resolve_asset_path(relative_path: str, search_roots: Iterable[str | Path] | None = None) -> str:
...
def resolve_font_path(font_path_or_file: str, search_roots: Iterable[str | Path] | None = None) -> str:
    ...
    return resolve_asset_path(normalized, search_roots=search_roots)


def resolve_icon_path(icon_path_or_file: str, search_roots: Iterable[str | Path] | None = None) -> str:
