...
UI_FEATURE_ICON_SIZE_SCALE = 0.625
UI_TERRAIN_ICON_SIZE_SCALE = UI_FEATURE_ICON_SIZE_SCALE
UI_FEATURE_ICON_ALPHA = 96
UI_EXPOSED_ICON_Y_OFFSET_SCALE = 0.62
UI_EXPOSED_ICON_SIZE_SCALE = 0.30
UI_SETTLEMENT_ICON_SIZE_SCALE = 1.50
UI_CAPITAL_ICON_SIZE_SCALE = UI_SETTLEMENT_ICON_SIZE_SCALE
UI_TOWN_ICON_SIZE_SCALE = UI_SETTLEMENT_ICON_SIZE_SCALE
UI_TROOP_DOT_RADIUS_SCALE = 0.088
UI_TROOP_DOT_OUTLINE_WIDTH_SCALE = 0.24
UI_TROOP_DOT_SEGMENTS = 96
UI_TROOP_LAYOUT_SCALE = 1.00

# Icons
ICON_PATH_FOREST = "icons/forest_64_filled.png"
ICON_PATH_MOUNTAIN = "icons/mountain_64_filled.png"
ICON_PATH_DANGER = "icons/alert_64_filled.png"
ICON_PATH_CAPITAL = "icons/star_64_filled.png"
ICON_PATH_TOWN = "icons/circle_64.png"
